(function() {
	...
	H5lock.prototype.initDom = function() {
		...
		canvas.setAttribute('id', 'h5lockcanvas');
		canvas.style.cssText = '';
		var str = '<h4 id="title" class="title" style="color:#000">请绘制您的图形密码</h4>' +
			'<a id="updatePassword" style="position: absolute;right: 5px;top: 5px;color:#000;display:none;">重置密码</a>';
		wrap.innerHTML = str;
